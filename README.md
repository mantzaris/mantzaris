...
- **[TagasaurusMemetic](https://github.com/mantzaris/TagasaurusMemetic)**: The original "Tag your Planet" app - gateway to your semantic multiverse. Here memes and emotions take a first place position in search with specific features to allow for users to search for the impact of memes on certain keywords by utilizing a bi-partite graph.  
